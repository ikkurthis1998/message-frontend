...
const ChatBox = () => {
    ...
    return (
        <div className="w-96 h-5/6 border flex flex-col justify-end bg-gray-200 rounded m-5 box-border">
            ...
            <form onSubmit={(e) => sendMessage(e)} className="mb-5 flex mx-2">
                ...
                <button type="submit" className="w-20 border bg-green-300 border border-green-300 rounded" >Send</button>
            </form>
        </div>
    )
};
